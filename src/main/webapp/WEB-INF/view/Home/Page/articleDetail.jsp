        ...
        <main id="main" class="site-main" role="main">
            <article class="post" id="articleDetail" data-id="${article.articleId}">
                ...
                <div class="entry-content">
                    ...
                    <div class="s-weixin">
                        <ul class="weimg1">
                            <li><strong>技术干货公众号</strong></li>
                            <li>赶快加我聊天吧</li>
                            <li><img src="/img/weixin.jpg" width="192px" height="192px"></li>
                        </ul>
                        <ul class="weimg2">
                            <li><strong>Java技术学习社区</strong></li>
                            <li>加入一起学习Java吧</li>
                            <li><img src="/img/ydykt-wx.png" width="192px" height="192px" alt="weinxin"></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
